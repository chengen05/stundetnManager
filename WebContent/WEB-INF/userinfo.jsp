                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                          <s:iterator value="#request.userInfoList" id="userInfo">
                            <tr>
                              ...
                              <td>
                              	<s:if test="#userInfo.userRoleId==1">学生</s:if>
								<s:if test="#userInfo.userRoleId==4">超级管理员</s:if>
                            	<s:if test="#userInfo.userRoleId==2">老师</s:if>
                              </td>
                              <td><a href="updateUserInfo.action?id=${userInfo.userId}"><button>修改</button></a></td>
                              <td><a href="delUserInfo.action?id=${userInfo.userId}"><button>删除</button></a></td>
                            </tr>
                            </s:iterator>
                          </tbody>
                        </table>
