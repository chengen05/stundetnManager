                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                          <s:iterator value="#request.schoolDepartments" id="school">
                            <tr>
                              <td>${school.departmentName}</td>
                              <td><s:if test="#school.departmentType==0">教学单位</s:if>
                              		<s:if test="#school.departmentType==1">行政部门</s:if>
                              </td>
                              <td>${school.departmentLinkman}</td>
